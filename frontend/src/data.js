// Crop Advisory Knowledge Base & Translations for Uttarakhand Agriculture
...
export const DISEASES = [
  {
    ...
    image: "https://images.unsplash.com/photo-1592924357228-91a4daadcfea?w=600&auto=format&fit=crop&q=80" // Representative image
  },
  {
    id: "rust",
    nameEn: "Rust",
  ...
  },
  {
    ...
    symptomsHi: "पत्तियों पर संकेंद्रित छल्लों (निशाने जैसे बोर्ड) के साथ छोटे, गोलाकार भूरे या काले धब्बे बनना, जिससे पत्तियां झड़ने लगती हैं।",
...
export const POST_HARVEST_GUIDES = [
  {
    id: "harvesting",
  ...
  },
  {
    ...
    itemsHi: [
      "टमाटरों को 12-15°C तापमान और 85-90% सापेक्ष आर्द्रता पर स्टोर करें। उन्हें कभी भी 10°C से नीचे न रखें क्योंकि उन्हें पाला (चिलिंग इंजरी) लग सकता है।",
...
export const SUGGESTED_QUESTIONS = [
  {
    textEn: "My tomato leaves have yellow spots",
    textHi: "मेरे टमाटर के पत्तों पर पीले धब्बे हैं",
    crop: "tomato"
  },
  {
    textEn: "How to control aphids?",
    textHi: "एफिड्स (माहू) को कैसे नियंत्रित करें?",
    crop: "mustard"
  },
  {
    textEn: "Best fertilizer for wheat?",
    textHi: "गेहूं के लिए सबसे अच्छा उर्वरक कौन सा है?",
    crop: "wheat"
  },
  {
    textEn: "Post-harvest storage tips for potato",
    textHi: "आलू के लिए कटाई के बाद भंडारण के टिप्स",
    crop: "potato"
  }
];
...
export const TRANSLATIONS = {
  en: {
    title: "Mandakini Organic Advisor",
    subtitle: "AI Crop Advisory for Mandakini Organic Produce Collective field supervisors.",
    dashboard: "Dashboard",
    aiChatAssistant: "AI Chat Assistant",
    diseaseGuide: "Disease Guide",
    pestManagement: "Pest Management",
    postHarvestGuide: "Post-Harvest Guide",
    ...
    searchPlaceholder: "Search crops, diseases, pests...",
    searchButton: "Search",
    ...
    // Dashboard widgets
    welcomeSupervisor: "Welcome, Mandakini Collective Supervisor 👋",
    summaryTitle: "Overview Statistics",
    totalQuestions: "Total Questions Asked",
    diseaseQueries: "Disease Queries",
    pestQueries: "Pest Queries",
    postHarvestQueries: "Post-Harvest Queries",
    savedConversations: "Saved Chats",
    quickActions: "Quick Actions",
    askQuestionAction: "Ask a Question",
    browseGuidesAction: "Browse Crop Guides",
    readPostHarvestAction: "Read Storage Tips",
    uttarakhandWeatherAlert: "Uttarakhand Weather & Crop Alerts",
    alertHumidityTitle: "High Humidity Alert (Hills)",
    alertHumidityText: "Pithoragarh and Almora reporting relative humidity >85%. Tomato & Potato crops are at high risk for Late Blight. Advise fields to check lower leaves.",
    alertRainfallTitle: "Rabi Harvesting Warning (Plains)",
    alertRainfallText: "Light showers predicted in Haridwar/Udham Singh Nagar. Ensure harvested wheat is covered with tarpaulins immediately. Avoid winnowing in wind.",
    recentActivity: "Recent Activity Logs",
    activity1: "Performed Late Blight check on Tomato in Nainital block.",
    activity2: "Loaded post-harvest packaging checklist for Kidney Beans (Rajma).",
    activity3: "Configured Gemini API key in settings.",

    // Chatbot UI
    welcomeChatTitle: "Mandakini Organic AI Advisor",
    welcomeChatSubtitle: "Ask me anything about diseases, pests, bio-fertilizers, or organic post-harvest storage.",
    suggestedQuestionsTitle: "Suggested Questions:",
    inputPlaceholder: "Type your agricultural query here...",
    voiceButton: "Voice Input",
    voiceListening: "Listening... speak now",
    sendButton: "Send",
    newChat: "New Chat",
    thinking: "AI Advisor is analyzing...",
    ttsRead: "Read Advice Aloud",
    ttsStop: "Stop Audio",
    saveChat: "Save Chat",
    chatSavedSuccess: "Conversation saved successfully!",
    apiKeyWarning: "Running in offline mode. Configure your Gemini API key in Settings for live AI responses.",
    ...
    verificationDisclaimer: "Verification Disclaimer",
    officialSealText: "ADVISORY REPORT",

    // Guides
    searchGuidesPlaceholder: "Filter by crop name (e.g. Tomato)...",
    allCrops: "All Crops",
    scientificNameLabel: "Scientific Name",
    pathogenLabel: "Pathogen",
    affectedCropsLabel: "Affected Crops",
    symptomsLabel: "Symptoms",
    preventionLabel: "Prevention Methods",
    treatmentLabel: "Treatment & Control",
    viewDetails: "View Details",
    closeButton: "Close",
    pestsFound: "Common Pests Profiled",
    diseasesFound: "Plant Diseases Profiled",
    postHarvestTopicLabel: "Compliance Checkpoints",
    noResults: "No entries found matching your search.",

    // Chat History UI
    searchHistoryPlaceholder: "Search chat history...",
    noHistory: "No saved chat history found.",
    deleteChat: "Delete Conversation",
    loadChat: "Load Conversation",

    // Settings UI
    settingsTitle: "Supervisor Settings",
    apiConfigHeader: "Gemini API Configuration",
    apiKeyLabel: "Your Gemini API Key",
    apiKeyPlaceholder: "Paste your API key here (AI_zaSy...)",
    apiKeyHelp: "Your key is saved locally in your browser and used to query Gemini models directly. No backend server stores your key.",
    offlineModeActive: "Offline mode is active. System uses local knowledge base fallback.",
    onlineModeActive: "Live Gemini API mode is active.",
    saveSettings: "Save Settings",
    settingsSavedSuccess: "Settings saved successfully!",
    tempLabel: "Creativity (Temperature)",
    languagePrefLabel: "Default Language",
    systemPromptLabel: "Active System Instructions",
    systemPromptVal: "Organic agriculture specialist advising Mandakini Organic Produce Collective supervisors on organic IPM, bio-controls (Trichoderma, Neem), and organic post-harvest compliance."
  },
  hi: {
    title: "मंदाकिनी ऑर्गेनिक सलाहकार",
    subtitle: "मंदाकिनी ऑर्गेनिक प्रोड्यूस कलेक्टिव के क्षेत्र पर्यवेक्षकों के लिए त्वरित एआई फसल सलाह।",
    dashboard: "डैशबोर्ड",
    aiChatAssistant: "एआई चैट सहायक",
    diseaseGuide: "रोग मार्गदर्शिका",
    pestManagement: "कीट प्रबंधन",
    postHarvestGuide: "कटाई के बाद गाइड",
    ...
    searchPlaceholder: "फसलें, रोग, कीट खोजें...",
    searchButton: "खोजें",
    ...
    // Dashboard widgets
    welcomeSupervisor: "स्वागत है, मंदाकिनी कलेक्टिव पर्यवेक्षक 👋",
    summaryTitle: "अवलोकन आंकड़े",
    totalQuestions: "कुल पूछे गए प्रश्न",
    diseaseQueries: "रोग संबंधी प्रश्न",
    pestQueries: "कीट संबंधी प्रश्न",
    postHarvestQueries: "कटाई के बाद के प्रश्न",
    savedConversations: "सहेजी गई चैट",
    quickActions: "त्वरित कार्य",
    askQuestionAction: "प्रश्न पूछें",
    browseGuidesAction: "फसल गाइड देखें",
    readPostHarvestAction: "भंडारण टिप्स पढ़ें",
    uttarakhandWeatherAlert: "उत्तराखंड मौसम और फसल चेतावनियां",
    alertHumidityTitle: "उच्च आर्द्रता चेतावनी (पहाड़ी क्षेत्र)",
    alertHumidityText: "पिथौरागढ़ और अल्मोड़ा में सापेक्ष आर्द्रता >85% दर्ज की गई। टमाटर और आलू की फसलों में पछेती झुलसा का उच्च जोखिम है। निचली पत्तियों की जाँच करें।",
    alertRainfallTitle: "रबी कटाई चेतावनी (मैदानी क्षेत्र)",
    alertRainfallText: "हरिद्वार/ऊधम सिंह नगर में हल्की बारिश का अनुमान। सुनिश्चित करें कि कटे हुए गेहूं को तुरंत तिरपाल से ढक दिया जाए। हवा में ओसाने से बचें।",
    recentActivity: "हालिया गतिविधि लॉग",
    activity1: "नैनीताल ब्लॉक में टमाटर पर पछेती झुलसा रोग की जांच की गई।",
    activity2: "राजमा (बीन) के लिए कटाई के बाद पैकेजिंग चेकलिस्ट लोड की गई।",
    activity3: "सेटिंग्स में जेमिनी एपीआई की (Key) को कॉन्फ़िगर किया गया।",

    // Chatbot UI
    welcomeChatTitle: "मंदाकिनी ऑर्गेनिक एआई सलाहकार",
    welcomeChatSubtitle: "फसलों के रोगों, कीटों, जैव-उर्वरकों या कटाई के बाद जैविक भंडारण के बारे में मुझसे कुछ भी पूछें।",
    suggestedQuestionsTitle: "सुझाए गए प्रश्न:",
    inputPlaceholder: "अपनी कृषि संबंधी समस्या यहाँ लिखें...",
    voiceButton: "आवाज इनपुट",
    voiceListening: "सुन रहा हूँ... अब बोलें",
    sendButton: "भेजें",
    newChat: "नई चैट",
    thinking: "एआई सलाहकार विश्लेषण कर रहा है...",
    ttsRead: "सलाह जोर से सुनें",
    ttsStop: "ऑडियो रोकें",
    saveChat: "चैट सहेजें",
    chatSavedSuccess: "बातचीत सफलतापूर्वक सहेजी गई!",
    apiKeyWarning: "ऑफ़लाइन मोड में चल रहा है। लाइव प्रतिक्रियाओं के लिए सेटिंग्स में जेमिनी एपीआई की (API Key) दर्ज करें।",
    ...
    verificationDisclaimer: "सत्यापन अस्वीकरण",
    officialSealText: "सलाहकार रिपोर्ट",

    // Guides
    searchGuidesPlaceholder: "फसल के नाम से खोजें (जैसे टमाटर)...",
    allCrops: "सभी फसलें",
    scientificNameLabel: "वैज्ञानिक नाम",
    pathogenLabel: "रोगजनक",
    affectedCropsLabel: "प्रभावित फसलें",
    symptomsLabel: "लक्षण",
    preventionLabel: "रोकथाम के तरीके",
    treatmentLabel: "उपचार और नियंत्रण",
    viewDetails: "विवरण देखें",
    closeButton: "बंद करें",
    pestsFound: "प्रोफाइल किए गए आम कीट",
    diseasesFound: "प्रोफाइल की गई पादप बीमारियां",
    postHarvestTopicLabel: "अनुपालन बिंदु",
    noResults: "आपकी खोज से मेल खाने वाली कोई प्रविष्टि नहीं मिली।",

    // Chat History UI
    searchHistoryPlaceholder: "चैट इतिहास खोजें...",
    noHistory: "कोई सहेजा गया चैट इतिहास नहीं मिला।",
    deleteChat: "बातचीत हटाएं",
    loadChat: "बातचीत लोड करें",

    // Settings UI
    settingsTitle: "पर्यवेक्षक सेटिंग्स",
    apiConfigHeader: "जेमिनी एपीआई कॉन्फ़िगरेशन",
    apiKeyLabel: "आपका जेमिनी एपीआई की (Key)",
    apiKeyPlaceholder: "अपनी एपीआई की यहाँ पेस्ट करें (AI_zaSy...)",
    apiKeyHelp: "आपकी की (Key) आपके ब्राउज़र में स्थानीय रूप से सहेजी जाती है और जेमिनी मॉडल से सीधे प्रश्न पूछने के लिए उपयोग की जाती है। कोई भी बाहरी सर्वर इसे सहेजता नहीं है।",
    offlineModeActive: "ऑफ़लाइन मोड सक्रिय है। सिस्टम स्थानीय ज्ञान का उपयोग करेगा।",
    onlineModeActive: "लाइव जेमिनी एपीआई मोड सक्रिय है।",
    saveSettings: "सेटिंग्स सहेजें",
    settingsSavedSuccess: "सेटिंग्स सफलतापूर्वक सहेजी गईं!",
    tempLabel: "रचनात्मकता (तापमान)",
    languagePrefLabel: "डिफ़ॉल्ट भाषा",
    systemPromptLabel: "सक्रिय सिस्टम निर्देश",
    systemPromptVal: "जैविक कृषि विशेषज्ञ जो मंदाकिनी ऑर्गेनिक प्रोड्यूस कलेक्टिव के पर्यवेक्षकों को जैविक कीट नियंत्रण (ट्राइकोडर्मा, नीम) और जैविक भंडारण अनुपालन पर सलाह देता है।"
  }
};
